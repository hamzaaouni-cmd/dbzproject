...
<div id='myDIV'>
    ...
    <img id="targetImg" src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKaGM00ae3EJQzySR6MpT58X7d_5d6qtSkHQ&s' style='border-radius:30px; width:200px; display:block; margin:auto;' /><br>
...
<?php
echo "<center><button onclick='myFunction()'>Afficher / Cacher</button></center>";
echo "<button onclick='miFunction()'>Indice</button>";
?>

<script>
    let single = <?php echo $response; ?>;
    let all = <?php echo $responseAll; ?>;
    let tries = 0;
    let maxTries = 6;
        ...
        if (input.length > 0 && result.length > 0) {
            result.forEach(function(r) {
                ...
                item.onclick = function() {
                    ...
                    let rPlanet = r.originPlanet && r.originPlanet.name ? r.originPlanet.name : null;
                    let sPlanet = single.originPlanet && single.originPlanet.name ? single.originPlanet.name : null;
                    ...
                    let kiColor = r.ki === single.ki ? "green" : "red";
                    let maxKiColor = r.maxKi === single.maxKi ? "green" : "red";
                    let planetColor = (rPlanet === sPlanet) ? "green" : "red";
                    ...
                    attemptDiv.innerHTML =
                        ...
                        "Genre: <span style='color:" + genderColor + "'>" + (r.gender || "Inconnu") + "</span><br>" +
                        "KI de base: <span style='color:" + kiColor + "'>" + (r.ki || "Inconnu") + "</span><br>" +
                        "KI max: <span style='color:" + maxKiColor + "'>" + (r.maxKi || "Inconnu") + "</span><br>" +
                        "Planète: <span style='color:" + planetColor + "'>" + (rPlanet || "Inconnue") + "</span>";
